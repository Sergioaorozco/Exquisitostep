...
export default {
  data() {
    return {
      ...
      isSelected: null,
      details: [
        {body:'Horse', img:'this is an image'},
        {body:'Whale', img:'this is an image'},
        {body:'Bird', img:'this is an image'},
        {body:'Spider', img:'this is an image'},
        {body:'Chamaleon', img:'this is an image'},
        {body:'Octopus', img:'this is an image'},
      ],
      items: [
        {
            label: 'Select Type',
